            ...
            {ITEMS.map((item) =>
              item.href ? (
                <a
                  ...
                  className={cn(
                    "relative flex size-fit shrink-0 scale-100 select-none appearance-none items-center justify-center rounded-[10px] px-2 py-1.5 text-stone-500 transition-colors hover:bg-stone-950 hover:text-stone-100 focus-visible:ring-2 active:scale-[0.98]",
