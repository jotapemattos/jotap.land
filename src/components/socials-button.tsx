...
export function SocialsButton({ href, text }: SocialsButtonProps) {
  return (
    <a
      href={href}
      target="_blank"
      className="group relative inline-flex items-center justify-center font-serif text-stone-300 underline transition-colors duration-200 hover:text-stone-500">
      <>
        <span>{text}</span>
